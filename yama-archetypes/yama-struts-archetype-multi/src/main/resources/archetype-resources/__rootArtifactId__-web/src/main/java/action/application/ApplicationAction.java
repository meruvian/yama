 ...
 */
package ${package}.action.application;
...
import ${groupId}.repository.application.Application;
import ${groupId}.repository.application.DefaultApplication;
import ${groupId}.service.ApplicationManager;
