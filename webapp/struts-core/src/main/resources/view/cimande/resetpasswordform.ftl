<@s.form id="change-password" theme="bootstrap" cssClass="form-horizontal" action="reset">
	<@s.hidden name="confirmationId" />
	<@s.password id="newpass1" label="New Password" name="password" tooltip="Enter your new password" placeholder="new password..." />
	<@s.password id="newpass2" label="Confirm password" name="cpassword" tooltip="Confirm password" placeholder="confirm password..." />
