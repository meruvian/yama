...
import org.meruvian.yama.security.oauth.JpaOauthApplicationApproval;
import org.meruvian.yama.security.oauth.JpaOauthApplicationApprovalRepository;
import org.meruvian.yama.security.oauth.OauthApplicationApproval.ApprovalStatus;
...
public class JpaOauthApplicationApprovalManager implements OauthApplicationApprovalManager {
	...
	public void postConstruct() {
		Validate.notNull(approvalRepository, "JpaOauthApplicationApprovalRepository must be provided");
	...
	public boolean addApprovals(Collection<Approval> approvals) {
		for (Approval approval : approvals) {
			...
			if (a != null) {
				...
				a.setApplication(new JpaApplication(approval.getClientId()));
				a.setExpiresAt(approval.getExpiresAt());
